...
[h1]Latest version : 1.6.3
This works on SP/MP 
Supports game version: 1.10.8 [/h1]
...
- REWORK of the mod (Version 2.0; Release TBA)
...
- Cleaning files for rework
- Preparing: upload for rework
- Uploaded first part of the rework (it wont work yet)
...
- Removed file "betteraiold.jpg" out the mod
